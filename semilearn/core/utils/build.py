...
def get_dataset(args, algorithm, dataset, num_labels, num_classes, data_dir='./data', include_lb_to_ulb=True):
    ...
    """
    from semilearn.datasets import get_eurosat, get_medmnist, get_semi_aves, get_cifar, get_svhn, get_stl10, get_imagenet, get_json_dset, get_pkl_dset, get_market1501
    ...
    if dataset == "eurosat":
        ...
        lb_dset, ulb_dset, eval_dset = get_market1501(args, algorithm, num_labels=num_labels, num_classes=num_classes, data_dir=data_dir)
        test_dset = None
